...
class Settings {
    ...
    async javaPath() {
        ...
        let configClient = await this.db.readData('configClient')
        let javaPath = configClient?.java_config?.java_path || 'Use the java version included with the launcher';
        ...
        document.querySelector(".java-path-set").addEventListener("click", async () => {
            ...
            } else alert("The file name must be java or javaw");
        });

        document.querySelector(".java-path-reset").addEventListener("click", async () => {
            let configClient = await this.db.readData('configClient')
            javaPathInputTxt.value = 'Use the java version included with the launcher';
