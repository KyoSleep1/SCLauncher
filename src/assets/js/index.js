...
class Splash {
    ...
    async checkUpdate() {
        this.setStatus(`Searching for updates...`);

        ipcRenderer.invoke('update-app').then().catch(err => {
            return this.shutdown(`error during update search:<br>${err.message}`);
        });
    ...
    async dowloadUpdate() {
        ...
        document.querySelector(".download-update").addEventListener("click", () => {
            ...
            return this.shutdown("Download in progress...");
        });
    }
    ...
    shutdown(text) {
        ...
        let i = 4;
        setInterval(() => {
            this.setStatus(`${text}<br>Shutdown in ${i--}s`);
